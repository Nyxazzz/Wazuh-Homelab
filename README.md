...
Aprender a desplegar y administrar Wazuh.
Monitorizar servidores Linux mediante Wazuh Agent.
Analizar logs de Apache.
Realizar ataques controlados contra servicios web.
...
Documentar todo el proceso desde la perspectiva de Red Team y Blue Team.
